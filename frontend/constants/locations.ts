...
export function getProvincesByRegion(regionName: string): Province[] {
  ...
  return PROVINCES.filter(
    (province) => province.regionPsgc === region.psgc && (province.geoLevel === "Prov" || province.geoLevel === "Dist")
  );
}

export function getMunicipalitiesByProvince(provinceName: string): Municipality[] {
...
export function getBarangaysByMunicipality(municipalityName: string): Barangay[] {
...
export function getMunicipalityName(municipalityPsgc: string): string | undefined {
