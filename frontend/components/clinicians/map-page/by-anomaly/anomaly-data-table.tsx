...
export const ReasonBadge = ({ code }: { code: string }) => {
...
export const AnomalyDataTable = ({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between py-2 mb-2">
