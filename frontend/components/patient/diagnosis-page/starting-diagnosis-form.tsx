        ...
        <div className="space-y-12 w-full text-center">
          <div className="space-y-8">
            <div className="flex justify-between items-start shadow-xl bg-base-100/90 border border-base-300/30 rounded-2xl outline-none w-full h-auto px-4 py-3 backdrop-blur-xl transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]">
              <textarea
                className="flex-1 pl-1 border-none outline-none bg-transparent resize-none text-lg font-medium text-base-content placeholder:text-muted transition-all duration-300 min-h-[56px]"
              ...
              <button
                type="submit"
                className="ml-3 p-0 w-12 h-12 aspect-square rounded-xl bg-primary text-primary-content shadow-md hover:shadow-xl hover:bg-primary/90 active:scale-95 transition-all duration-200 flex items-center justify-center"
              >
